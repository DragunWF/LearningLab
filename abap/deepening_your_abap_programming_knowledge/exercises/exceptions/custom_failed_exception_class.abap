* ============================================================
* ==============================
* THIS ASSUMES YOU HAVE A CUSTOM MESSAGE CLASS WITH A NUMBER 001, 002 AND DESCRIPTIONS
* ==============================
* ============================================================
...
CLASS zcx_8141_failed DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF carrier_not_exist,
        msgid TYPE symsgid VALUE 'z8141_MESSAGES',
...
CLASS zcx_8141_failed IMPLEMENTATION.
