...
CLASS zcl_8141_solution_23 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_8141_solution_23 IMPLEMENTATION.
...
*    CONSTANTS c_carrier_id TYPE /dmo/carrier_id VALUE 'UA'.
    ...
    TRY.
      ...
      CATCH zcx_8141_failed INTO DATA(exc_fail).
...
CLASS lcl_carrier IMPLEMENTATION.
  ...
  METHOD get_instance.
    ...
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE zcx_8141_failed
        exporting
            textid = zcx_8141_failed=>carrier_not_exist
            carrier_id = i_carrier_id.
    ENDIF.
    ...
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE zcx_8141_failed
        exporting
            textid = zcx_8141_failed=>carrier_no_read_auth
            carrier_id = i_carrier_id.
    ENDIF.
