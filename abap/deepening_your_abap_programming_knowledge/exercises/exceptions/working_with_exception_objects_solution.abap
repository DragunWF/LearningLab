...
CLASS zcl_8141_solution_22 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_8141_solution_22 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

* LH for normal execution
* XX to provoke invalid value exception
* UA to provoke exception for missing authorization
