...
CLASS zcl_8141_solution_3 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_8141_solution_3 IMPLEMENTATION.
...
CLASS lcl_passenger_flight DEFINITION .
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA: flight_buffer TYPE TABLE OF st_flights_buffer.
...
CLASS lcl_passenger_flight IMPLEMENTATION.
  ...
  METHOD get_flights_by_carrier.
    ...
    SELECT
      ...
      INTO TABLE @flight_buffer.

    LOOP AT flight_buffer INTO DATA(flight).
  ...
  METHOD constructor.
    ...
    TRY.
        DATA(flight_raw) = flight_buffer[ carrier_id = i_carrier_id
