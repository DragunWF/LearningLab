CLASS zcl_392_structured_data_types DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_392_structured_data_types IMPLEMENTATION.
...
**********************************************************************
    ...
    DATA dragunwf TYPE player.

    dragunwf-username = 'dragunwf'.
    dragunwf-age = 22. " Not my actual age btw, of course I won't put that sensitive info here
    dragunwf-level = 50.
    dragunwf-classType = 'Programmer Wizard'.
